...
if calc_sens:
    ...
    #calculating flux
    n_sig_disc = disc['n_sig']
    n_sig_err_disc = disc['n_sig_error']
    
    disc_flux = tr.to_E2dNdE(n_sig_disc, E0=100, unit=1e3)
    disc_flux_err = (
        tr.to_E2dNdE(n_sig_disc + n_sig_err_disc, E0=100, unit=1e3)
        - disc_flux
    )
    disc['flux'] = disc_flux
    disc['flux_err'] = disc_flux_err
